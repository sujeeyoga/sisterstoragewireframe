...
export const SisterStoriesCarousel = () => {
  ...
  return (
    <div className="w-full overflow-hidden relative">
      {/* Left fade gradient - 25% */}
      <div className="absolute left-0 top-0 bottom-0 w-[25%] bg-gradient-to-r from-[hsl(var(--brand-gray))] to-transparent z-10 pointer-events-none" />
      
      {/* Right fade gradient - 25% */}
      <div className="absolute right-0 top-0 bottom-0 w-[25%] bg-gradient-to-l from-[hsl(var(--brand-gray))] to-transparent z-10 pointer-events-none" />
          ...
          <CarouselContent className="ml-4 md:ml-8">
            {videoStories.map((story) => (
              <CarouselItem key={story.id} className="pl-4 basis-full md:basis-[calc(70%-1.5rem)]">
                ...
                >
                  <div 
                    className="relative h-[90vh] overflow-hidden bg-black cursor-pointer"
