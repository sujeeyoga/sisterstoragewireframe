    ...
    <section ref={parallaxRef} className="relative w-full overflow-hidden" aria-label="Hero section">
      ...
      <div className="hidden md:block">
        ...
        <div className="relative h-[90vh] flex items-center justify-start pt-0">
          <div className="bg-[hsl(var(--brand-pink))] flex items-center justify-start animate-[slide-left_1.2s_ease-out,expand-up_1.2s_ease-out_forwards] w-auto overflow-hidden shadow-2xl">
