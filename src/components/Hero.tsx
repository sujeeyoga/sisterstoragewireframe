  ...
  return (
    <section ref={parallaxRef} className="relative w-full overflow-hidden" aria-label="Hero section">
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[70%] h-[100%] overflow-hidden animate-[slide-in-right_0.8s_ease-out]">
          <img
            src={heroMainImage}
            alt="Woman showcasing Sister Storage jewelry organization solution"
        ...
        <div className="relative h-[90vh] flex items-center justify-start pt-0">
          <div className="bg-[hsl(var(--brand-pink))] flex items-center animate-[slide-in-right_0.8s_ease-out] w-full md:w-[60vw] lg:w-[55vw] overflow-hidden shadow-2xl rounded-r-[3rem]">
