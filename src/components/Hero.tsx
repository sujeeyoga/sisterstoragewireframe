  ...
  return (
    <section ref={parallaxRef} className="relative w-full overflow-hidden h-[70vh]" aria-label="Hero section">
      ...
      <div className="relative h-[70vh] flex items-center justify-start pt-0">
        <div className="bg-[hsl(var(--brand-pink))] flex items-center justify-center animate-[slide-left_1.2s_ease-out,expand-up_1.2s_ease-out_forwards] w-full md:w-[calc(100%-500px)] lg:w-[45%] overflow-hidden min-h-[600px] md:min-h-[700px] lg:min-h-[800px]">
          <div className="w-full max-w-[550px] pl-[max(32px,calc((100vw-1100px)/2+32px))] pr-8 md:pr-12 lg:pr-12 py-24 md:py-32 lg:py-[540px]">
