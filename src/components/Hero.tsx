  ...
  return (
    <section ref={parallaxRef} className="relative w-full overflow-hidden" aria-label="Hero section">
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[70%] h-[100%] rounded-b-[25%] overflow-hidden">
          <img
            src={heroMainImage}
            alt="Woman showcasing Sister Storage jewelry organization solution"
        ...
        <div className="relative h-[90vh] flex items-center justify-start pt-0">
          <div className="bg-[hsl(var(--brand-pink))] flex items-center justify-start animate-[slide-left_1.2s_ease-out_forwards] w-auto overflow-hidden shadow-2xl rounded-r-[3rem]">
