      ...
      <div className={`w-full flex items-center justify-between transition-all duration-300 ${
        ...
        <div className="shrink-0 flex items-center gap-2">
          <button
            ...
            className="nav-item p-2 text-black hover:bg-black/10 rounded transition-colors relative focus:outline-none focus:ring-2 focus:ring-[hsl(var(--brand-pink))] min-h-[44px] min-w-[44px] flex items-center justify-center"
          ...
          <button 
            className="nav-item lg:hidden p-2 text-black focus:outline-none hover:bg-black/10 rounded transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center focus:ring-2 focus:ring-[hsl(var(--brand-pink))]"
