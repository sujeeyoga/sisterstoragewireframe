  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-6 mb-8">
        <Button 
          className="px-8 py-6 text-lg w-full sm:w-auto group relative overflow-hidden transition-all duration-300 animate-breath-fade-up-4 bg-white text-black hover:bg-[#E90064] hover:text-white border-4 border-white hover:border-[#E90064] font-black"
          asChild
        >
      ...
      <AnimatedText
        as="p"
        className="text-lg text-white max-w-xl leading-relaxed font-medium"
